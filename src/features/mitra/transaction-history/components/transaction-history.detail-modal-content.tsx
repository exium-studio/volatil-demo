// src/features/mitra/transaction-history/components/transaction-history.detail-modal-content.tsx
...
import type { TransactionDetailModalContentProps } from "@/features/mitra/transaction-history/types/transaction-history.modal.type";
      ...
      <Modal.Body p={0}>
        {!isReady ? (
          <VStack gap={SPACING.md} p={SPACING.md} w={"full"}>
            <Skeleton h={"80px"} w={"full"} rounded={theme.radii.component} />
            <Skeleton h={"140px"} w={"full"} rounded={"md"} />
