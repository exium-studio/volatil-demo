...
export const dummyMitraDataAvailability: MitraHomeDataAvailabilityResponse = {
  totalIgt: 30,
  bidang: 10,
  kawasan: 20,
};

export const dummyMitraDataSummary: Record<
  MitraHomePeriod,
  MitraHomeDataSummaryResponse
> = {
  "1d": {
...
export const dummyMitraFinancialFlow: Record<
  MitraHomePeriod,
  FinancialFlowItem[]
> = {
  "1d": [
...
export const dummyMitraCartSummary: MitraHomeCartSummaryResponse = {
  totalField: 12,
  totalArea: 4,
  totalIgtData: 16,
...
export const dummyMitraHomeData: HomeDataResponse = {
  dataSummary: dummyMitraDataSummary,
  financialFlow: dummyMitraFinancialFlow,
  cartSummary: dummyMitraCartSummary,
  lastTransactions: [
    {
      id: "tx-1",
